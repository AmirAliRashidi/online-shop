import { AfterViewChecked, AfterViewInit, Component, ElementRef, EventEmitter, Inject, Input, OnChanges, OnDestroy, OnInit, Optional, Output, QueryList, SimpleChanges, ViewChildren } from '@angular/core';
import { CodeInputComponentConfig, CodeInputComponentConfigToken, defaultComponentConfig } from './code-separator.component.config';
...
@Component({
  selector: 'app-code-separator',
  templateUrl: './code-separator.component.html',
  styleUrls: ['./code-separator.component.scss']
})
export class CodeSeparatorComponent implements AfterViewInit, OnInit, OnChanges, OnDestroy, AfterViewChecked {
